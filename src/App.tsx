...
export class App extends Component<IProps, IState> {
  ...
  componentDidMount = () => {
    let reactURL = `https://api.github.com/repos/facebook/react/tags`;
    let laravelURL = `https://api.github.com/repos/laravel/laravel/tags`;
    let reactAPIURL = `http://localhost:8000/api/frameworks/`;
    ...
    .then(() => {
      ...
      if(this.state.reactDatabase < this.state.reactLatest) {
        let version = this.state.reactLatest;
        let data = {
          name: 'react',
          version: version
        }
